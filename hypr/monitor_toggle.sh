...
#if $(hyprctl monitors | grep --quiet $INTERNAL_MONITOR); then
#	hyprctl keyword monitor "$INTERNAL_MONITOR, disable"
	#hyprctl keyword monitor "$EXTERNAL_MONITOR, 1920x1080@165, 0x0, 1"
#else
#	hyprctl keyword monitor "$INTERNAL_MONITOR, 1920x1080@60,1920x0,1.25"
	#hyprctl keyword monitor "$EXTERNAL_MONITOR, 1920x1080@165, 0x0, 1"
#if
